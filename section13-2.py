...
# DB 생성 & Auto Commit
# 본인 DB 경로
conn = sqlite3.connect('C:/workspaces/python_learn/resource/records.db', isolation_level=None)
...
# 입력값은 무조건 string 타입으로 받아올 수 있음
a = input("Ready? Press Enter Key!") # 입력 Enter Game Start!
